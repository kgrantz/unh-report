...
params:
  ...
  report_date: "2020-11-11" # date in YYYY-MM-DD
...
```{r Table-B1B-CampusCond}
  ...
  isol_bed_color_unh <- pick_color_threshold(isoldf$NAvgIsolBedPct[isoldf$campus_fac=="UNH Durham"]*100, thresholds=c(-1, 10, 50, 90))
                                             
  quar_bed_color_unh <- pick_color_threshold(quardf$NAvgQuarBedPct[quardf$campus_fac=="UNH Durham"]*100, thresholds=c(-1, 25, 50, 90))
