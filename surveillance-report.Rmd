...
```{r Figure-C8B-Quar-Proj, fig.cap=cap}
  ...
  cap <- glue("**Figure C{fig_counter}**. Projected number in quarantine dorm (bed) by day, by typical residence location, under the assumption that between 0.5x and 4x the amount of observed admissions into quarantine over the reporting period enter isolation in the next 7 days. The orange shaded region indicates the expected reduction from the maximum possible occupancy (4x admissions) if no off-campus students were admitted into the quarantine dorm for the next 7 days.")
...
```{r Figure-C12B-Isol-Proj, fig.cap=cap}
  ...
  cap <- glue("**Figure C{fig_counter}**. Projected number in isolation dorm (bed) by day, by typical residence location, under the assumption that between 0.5x and 4x the amount of observed admissions into isolation over the reporting period enter isolation in the next 7 days. The orange shaded region indicates the expected reduction from the maximum possible occupancy (4x admissions) if no off-campus students were admitted into the isolation dorm for the next 7 days.")
