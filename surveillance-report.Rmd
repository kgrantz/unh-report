...
```{r Table-B3-TestSubmitted, fig.cap=cap}
...
```{r Table-B4-MostRecentLab, fig.cap=cap}
...
```{r Table-C1-DurhamCond, fig.cap=cap}
  ...
  # This Week value + Threshold Indicator, if applicable
    ...
    filter(Indicator %in% c("Active Cases", "Active Cases per 1000", "Average number in isolation this week", "Average isolation beds in use (n, %)", "Average number in quarantine this week", "Average quarantine beds in use (n, %)")) %>%
    flextable() %>%
    bold(i=1, part="header") %>%
    set_header_labels(Indicator="",
...
```{r Table-C2-OnOffCampus, fig.cap=cap}
  ...
  tab_c2 <- ts_active_cases_offcamp %>%
  ...
  cap <- glue("**Figure C{tab_counter}**. Average number of daily 'Active Cases' among students at UNH Durham in the reporting period and in the week prior.")
  tab_counter <- tab_counter+1

```


```{r Table-C3-MostRecentLab, fig.cap=cap}
...
```{r Table-C4-TestSubmitted, fig.cap=cap}
...
```{r Table-C5-Lab, fig.cap=cap}
  ...
  cap <- glue("**Figure C{tab_counter}**. Laboratory operations (as number of tests returned with results and percent of all tests submitted) at UNH Durham in the reporting period and in the week prior.")
  tab_counter <- tab_counter+1
...
```{r Table-C6-DetailedTable, fig.cap=cap}
...
```{r Table-D1-ConcordCond, fig.cap=cap}
  ...
  indicatordf %>% 
    ...
    filter(Indicator %in% c("Active Cases", "Active Cases per 1000")) %>%
    flextable() %>%
    bold(i=1, part="header") %>%
    set_header_labels(Indicator="",
...
```{r Table-D2-OnOffCampus, eval=params$concord, fig.cap=cap}
  ...
  # average number daily active cases among students, by dorm vs no dorm
    ...
    # % change
    # sparkline % change all time
  tab_d2 <- ts_active_cases_offcamp %>%
  ...
  cap <- glue("**Figure D{tab_counter}**. Average number of daily 'Active Cases' among students at UNH Concord in the reporting period and in the week prior.")
  tab_counter <- tab_counter+1
  
```


```{r Table-D3-MostRecentLab, eval=params$concord, fig.cap=cap}
...
```{r Table-D4-TestSubmitted, eval=params$concord, fig.cap=cap}
...
```{r Table-D5-Lab, eval=params$concord, fig.cap=cap}
  ...
  cap <- glue("**Figure D{tab_counter}**. Laboratory operations (as number of tests returned with results and percent of all tests submitted) at UNH Concord in the reporting period and in the week prior.")
  tab_counter <- tab_counter+1
...
```{r Table-D6-DetailedTable, eval=params$concord, fig.cap=cap}
...
```{r Figure-E4-PropPositive, eval=params$manchester}
...
```{r Table-E2-OnOffCampus, eval=params$manchester}
  ...
  # average number daily active cases among students, by dorm vs no dorm
    ...
    # % change
    # sparkline % change all time
  tab_e2 <- ts_active_cases_offcamp %>%
  ...
  cap <- glue("**Figure C{tab_counter}**. Average number of daily 'Active Cases' among students at UNH Manchester in the reporting period and in the week prior.")
  tab_counter <- tab_counter+1
```


```{r Table-E3-MostRecentLab, eval=params$manchester, fig.cap=cap}
...
```{r Table-E4-TestSubmitted, eval=params$manchester, fig.cap=cap}
...
```{r Table-E5-Lab, eval=params$manchester, fig.cap=cap}
  ...
  cap <- glue("**Figure E{tab_counter}**. Laboratory operations (as number of tests returned with results and percent of all tests submitted) at UNH Manchester in the reporting period and in the week prior.")
  tab_counter <- tab_counter+1
  
```


```{r Figure-E5-Quar, eval=params$manchester}
...
```{r Table-E6-DetailedTable, eval=params$manchester, fig.cap=cap}
