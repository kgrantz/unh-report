...
```{r setup, include=FALSE}
  knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE, fig.topcaption = TRUE, error=TRUE)
...
```{r Table-B1B-CampusCond-12-full}
  # make flextable
  indicatordf %>% 
    flextable() %>%
    bold(i=1, part="header") %>%
